...
namespace ScaffoldTool.Events.PURORDMain
{
    public partial class FINSL
    {
        public FINSL()
        {
            ADMGSTINCESS_INPUT_SLCODENavigation = new HashSet<ADMGSTIN>();
            ADMGSTINCESS_OUTPUT_SLCODENavigation = new HashSet<ADMGSTIN>();
            ADMGSTINCGST_INPUT_SLCODENavigation = new HashSet<ADMGSTIN>();
            ADMGSTINCGST_OUTPUT_SLCODENavigation = new HashSet<ADMGSTIN>();
            ADMGSTINIGST_INPUT_SLCODENavigation = new HashSet<ADMGSTIN>();
            ADMGSTINIGST_OUTPUT_SLCODENavigation = new HashSet<ADMGSTIN>();
            ADMGSTINSGST_INPUT_SLCODENavigation = new HashSet<ADMGSTIN>();
            ADMGSTINSGST_OUTPUT_SLCODENavigation = new HashSet<ADMGSTIN>();
            ADMOUCONSIGNMENTSALE_SLCODENavigation = new HashSet<ADMOU>();
            ADMOUTRANSFERIN_SLCODENavigation = new HashSet<ADMOU>();
            ADMOUTRANSFEROUT_SLCODENavigation = new HashSet<ADMOU>();
            ADMOUTRANSITDIFF_SLCODENavigation = new HashSet<ADMOU>();
            ADMOUTRANSIT_SLCODENavigation = new HashSet<ADMOU>();
            ADMSITESLCODENavigation = new HashSet<ADMSITE>();
            ADMSITETRPCODENavigation = new HashSet<ADMSITE>();
            INVITEMPARTYCODENavigation = new HashSet<INVITEM>();
            INVITEMSLCODENavigation = new HashSet<INVITEM>();
            ...
            PURORDMAINAGCODENavigation = new HashSet<PURORDMAIN>();
            PURORDMAINPCODENavigation = new HashSet<PURORDMAIN>();
            PURORDMAINTRPCODENavigation = new HashSet<PURORDMAIN>();
        }
        ...
        public virtual ICollection<ADMGSTIN> ADMGSTINCESS_INPUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMGSTIN> ADMGSTINCESS_OUTPUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMGSTIN> ADMGSTINCGST_INPUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMGSTIN> ADMGSTINCGST_OUTPUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMGSTIN> ADMGSTINIGST_INPUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMGSTIN> ADMGSTINIGST_OUTPUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMGSTIN> ADMGSTINSGST_INPUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMGSTIN> ADMGSTINSGST_OUTPUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMOU> ADMOUCONSIGNMENTSALE_SLCODENavigation { get; set; }
        public virtual ICollection<ADMOU> ADMOUTRANSFERIN_SLCODENavigation { get; set; }
        public virtual ICollection<ADMOU> ADMOUTRANSFEROUT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMOU> ADMOUTRANSITDIFF_SLCODENavigation { get; set; }
        public virtual ICollection<ADMOU> ADMOUTRANSIT_SLCODENavigation { get; set; }
        public virtual ICollection<ADMSITE> ADMSITESLCODENavigation { get; set; }
        public virtual ICollection<ADMSITE> ADMSITETRPCODENavigation { get; set; }
        public virtual ICollection<INVITEM> INVITEMPARTYCODENavigation { get; set; }
        public virtual ICollection<INVITEM> INVITEMSLCODENavigation { get; set; }
        ...
        public virtual ICollection<PURORDMAIN> PURORDMAINAGCODENavigation { get; set; }
        public virtual ICollection<PURORDMAIN> PURORDMAINPCODENavigation { get; set; }
        public virtual ICollection<PURORDMAIN> PURORDMAINTRPCODENavigation { get; set; }
    }
}
