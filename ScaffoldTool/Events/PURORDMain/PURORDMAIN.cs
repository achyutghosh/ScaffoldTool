...
namespace ScaffoldTool.Events.PURORDMain
{
    public partial class PURORDMAIN
    {
        public PURORDMAIN()
        {
            PURORDCHG = new HashSet<PURORDCHG>();
            PURORDCHG_ITEM = new HashSet<PURORDCHG_ITEM>();
            PURORDDET = new HashSet<PURORDDET>();
        }
        ...
        public virtual FINSL PCODENavigation { get; set; }
        public virtual FINSL TRPCODENavigation { get; set; }
        public virtual ICollection<PURORDCHG> PURORDCHG { get; set; }
        public virtual ICollection<PURORDCHG_ITEM> PURORDCHG_ITEM { get; set; }
        public virtual ICollection<PURORDDET> PURORDDET { get; set; }
    }
}
